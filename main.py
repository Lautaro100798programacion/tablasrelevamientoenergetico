...
sel_ilu_1 = seleccion(df, 0, numeroDeFilas, 75, 83)
nombre_col_ilu = sel_ilu_1.columns
sel_ilu_2 = seleccion(df, 0, numeroDeFilas, 85, 93)
sel_ilu_2.columns = nombre_col_ilu
sel_ilu_3 = seleccion(df, 0, numeroDeFilas, 95, 103)
sel_ilu_3.columns = nombre_col_ilu


# seleccionar Equipamiento de oficina/informatico
sel_info_1 = seleccion(df, 0, numeroDeFilas, 105, 114)
